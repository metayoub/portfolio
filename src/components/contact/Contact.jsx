    ...
    return (
        <div id="contact" className="w-full h-screen bg-gray-50 flex flex-col justify-center  items-center mx-auto">
            <form onSubmit={onSubmit} className="w-full md:w-3/4 lg:w-3/6 p-4">
                ...
                <div className="p-3">
                    <input className="block appearance-none placeholder-gray-500 placeholder-opacity-100 border border-gray-400 rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:ring-2 focus:ring-gray-500"
                            type="email"
                            name="reply_to"
                ...
                <div className="p-3">
                    <textarea className="resize-none border rounded-md block appearance-none placeholder-gray-500 placeholder-opacity-100 border border-gray-400 rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:ring-2 focus:ring-gray-500 h-56" 
