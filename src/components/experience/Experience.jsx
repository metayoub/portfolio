    ...
    return (
        <div id="experience" className="container mx-auto my-auto w-full h-full">
            <div className="relative wrap overflow-hidden p-4 h-full">
                <div className="mb-8">
                    <p className="w-full flex justify-center text-2xl text-gray-800 font-bold">Experience</p>
                </div>
                ...
                {experience.map((item) => (
                    <div key={item.id} className={`mb-8 md:ml-0 flex justify-between ${item.id%2 === 0 ? "md:flex-row-reverse" : ""} items-center w-full right-timeline`}>
                        ...
                        <div className="z-20 flex items-center order-1 bg-gray-800 shadow-xl w-8 h-8 rounded-full mr-3 md:mr-0">
